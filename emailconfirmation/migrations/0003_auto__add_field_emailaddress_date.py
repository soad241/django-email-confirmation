...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'EmailAddress.date'
        db.add_column('emailconfirmation_emailaddress', 'date', self.gf('django.db.models.fields.DateField')(default=datetime.datetime(2011, 1, 1, 0, 0)), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'EmailAddress.date'
        db.delete_column('emailconfirmation_emailaddress', 'date')
