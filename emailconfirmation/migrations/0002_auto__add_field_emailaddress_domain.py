...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('emailconfirmation_emailaddress', 'domain', self.gf('django.db.models.fields.CharField')(default='', max_length=255), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'EmailAddress.domain'
        db.delete_column('emailconfirmation_emailaddress', 'domain')
